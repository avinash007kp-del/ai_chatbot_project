    ...
    <div className="settings-container">
      ...
      <div className="settings-section">
        ...
        <div className="setting-item">
          ...
          <button className="btn-primary" onClick={onLogout} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', background: 'transparent', color: 'var(--text-primary)', border: '1px solid var(--border-color)' }}>

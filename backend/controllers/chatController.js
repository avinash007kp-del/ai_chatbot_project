...
exports.sendMessage = async (req, res) => {
  try {
    ...
    if (process.env.GEMINI_API_KEY && process.env.GEMINI_API_KEY !== 'mock-key-to-prevent-crash') {
      ...
      const currentTimeString = new Date().toLocaleString(undefined, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit' });
      ...
      botResponseContent = `This is a mock response from the Node.js backend. You said: "${content}". (Add a GEMINI_API_KEY to backend/.env to enable real AI!)`;
    }
